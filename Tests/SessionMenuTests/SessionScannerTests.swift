    ...
    func buildsActiveSessionsFromShellOutput() async throws {
        let shell = StubShellRunner(outputs: [
            "/bin/ps|-ax|-o|pid=|-o|ppid=|-o|tty=|-o|etimes=|-o|command=": """
             ...
             20    10 ttys001  120 ssh user@example.com
             21    10 ttys001   80 node dev-server.js
            """,
            "/usr/sbin/lsof|-a|-n|-P|-p|20|-i": """
            COMMAND PID USER   FD   TYPE             DEVICE SIZE/OFF NODE NAME
            ssh      20 dev    3u  IPv4 0x1234567890abcdef      0t0  TCP 10.0.0.2:56123->192.168.1.15:22 (ESTABLISHED)
            """,
        ...
        #expect(sessions[0].target == "user@example.com")
        #expect(sessions[0].workingDirectory == "/Users/dev/my-app")
