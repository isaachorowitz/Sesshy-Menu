...
struct ScannerSupportTests {
    ...
    func resolvesTerminalAncestorName() {
        let processes = [
            ...
            ProcessSnapshot(pid: 20, parentPID: 10, tty: "ttys001", elapsedSeconds: 120, commandLine: "ssh user@example.com"),
        ]
    ...
    func filtersToTTYBackedCandidateProcesses() {
        let processes = [
            ProcessSnapshot(pid: 10, parentPID: 1, tty: "ttys001", elapsedSeconds: 300, commandLine: "ssh user@example.com"),
            ProcessSnapshot(pid: 11, parentPID: 1, tty: "??", elapsedSeconds: 300, commandLine: "ssh user@example.com"),
